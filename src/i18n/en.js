...
export default {
  ...
  'nb.title': 'Notebook',
  'nb.subtitle': '— Chain tools together: reference earlier cells via ${cell:N}, save as .bantb',
  'nb.add': '+ Add Cell',
  'nb.run': 'Run',
  'nb.run-all': 'Run All',
  'nb.save': '↓ Save (.bantb)',
  ...
  'nb.input': 'Input',
  'nb.output': 'Output',
  'nb.input.ph': 'Input or reference an earlier cell: ${cell:1}',
  'nb.refs-hint': 'Supports ${cell:1}, ${cell:1.users[0].email}',
  'nb.cell.type': 'Cell type',
  'nb.remove': 'Remove cell',
  // Feedback
