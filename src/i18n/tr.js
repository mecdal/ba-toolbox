...
export default {
  ...
  // Notebook / Workspace (Sprint 5c)
  'group.workspace': 'Çalışma Alanı',
  'nb.title': 'Notebook',
  'nb.subtitle': '— Birden çok aracı zincirle: ${cell:N} ile referans, .bantb dosyasına kaydet',
  'nb.add': '+ Hücre Ekle',
  'nb.run': 'Çalıştır',
  'nb.run-all': 'Tümünü Çalıştır',
  'nb.save': '↓ Kaydet (.bantb)',
  'nb.load': '↑ Yükle',
  'nb.clear-all': 'Sil',
  'nb.input': 'Giriş',
  'nb.output': 'Çıktı',
  'nb.input.ph': 'Giriş veya önceki hücre referansı: ${cell:1}',
  'nb.refs-hint': '${cell:1}, ${cell:1.users[0].email} desteklenir',
  'nb.cell.type': 'Hücre tipi',
  'nb.remove': 'Hücreyi sil',
  // Feedback
